...
function Header() {
    ...
    return (
        <header data-testid="app-header" >
            <nav role="nav" className="flex items-center justify-between flex-wrap bg-gray-800 p-6 fixed w-full z-10 top-0">
                <div className="flex items-center flex-shrink-0 text-white mr-6">
                    <div className="block p-1" data-testid="header-logo">
                        <img className="w-10" src="assets/images/logo.svg" data-testid="logoImg" alt=""/>
                    </div>
